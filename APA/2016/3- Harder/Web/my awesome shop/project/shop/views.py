...
def index(request, **kwargs):
    ...
    # Item.objects.get_or_create(name='test-item', price=0)
    # Item.objects.get_or_create(name='cloth', price=20)
    # Item.objects.get_or_create(name='flag1', price=100000, description="APACTF{okay,got_it,you_know_how_to_forge_requests...}")
